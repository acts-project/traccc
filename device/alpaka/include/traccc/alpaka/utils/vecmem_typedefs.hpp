...
typedef ::vecmem::cuda::managed_memory_resource managed_memory_resource;
...
typedef ::vecmem::hip::managed_memory_resource managed_memory_resource;
...
typedef ::vecmem::host_memory_resource host_memory_resource;
typedef ::vecmem::host_memory_resource managed_memory_resource;
