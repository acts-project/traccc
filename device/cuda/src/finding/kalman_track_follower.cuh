...
kalman_track_follower(
    ...
    const typename edm::measurement_collection<algebra_t>::const_device measurements{
        measurements_view};
    ...
    typename edm::track_container<algebra_t>::buffer
        track_candidates_buffer{
            ...
            {n_seeds * config.max_track_candidates_per_track, mr.main, vecmem::data::buffer_type::resizable},
            measurements_view};
    ...
    kalman_track_follower<propagator_t>(nBlocks, nThreads, 0, stream, config,
                    host_payload);
