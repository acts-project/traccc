...
class multiplet_estimator {
    ...
    size_t get_mid_bot_doublets_size(int n_spM) const {
        return (m_cfg.par_for_mb_doublets(n_spM) + m_cfg.safety_adder) * m_cfg.safety_factor;
    }
    ...
    size_t get_mid_top_doublets_size(int n_spM) const {
        return (m_cfg.par_for_mt_doublets(n_spM) + m_cfg.safety_adder) * m_cfg.safety_factor;
    }
    ...
    size_t get_triplets_size(int n_spM) const {
        return (m_cfg.par_for_triplets(n_spM) + m_cfg.safety_adder) * m_cfg.safety_factor;
    }
    ...
    size_t get_seeds_size(int n_internal_sp) const {
        return (m_cfg.par_for_seeds(n_internal_sp) + m_cfg.safety_adder) * m_cfg.safety_factor;
    }
