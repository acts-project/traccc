...
TEST_P(KalmanFittingWireChamberTests, Run) {
    ...
    traccc::io::read_detector(detector, host_mr,
                              path + "wire_chamber_geometry.json",
                              path + "wire_chamber_homogeneous_material.json",
                              path + "wire_chamber_surface_grids.json");
