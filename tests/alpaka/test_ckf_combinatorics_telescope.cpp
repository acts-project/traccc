...
TEST_P(CkfCombinatoricsTelescopeTests, Run) {
    ...
    // Only run this test on an accelerator.
#if !(defined(ALPAKA_ACC_GPU_CUDA_ENABLED) || \
      defined(ALPAKA_ACC_GPU_HIP_ENABLED) || defined(ALPAKA_ACC_SYCL_ENABLED))
    GTEST_SKIP() << "This test is only supported on an accelerator.";
#endif
    ...
    traccc::alpaka::combinatorial_kalman_filter_algorithm device_finding{
        cfg_no_limit, mr, copy, queue};
    traccc::alpaka::combinatorial_kalman_filter_algorithm device_finding_limit{
        cfg_limit, mr, copy, queue};
...
INSTANTIATE_TEST_SUITE_P(
    AlpakaCkfCombinatoricsTelescopeValidation, CkfCombinatoricsTelescopeTests,
    ::testing::Values(
