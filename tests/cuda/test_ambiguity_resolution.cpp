...
TEST(CudaAmbiguitySolverTests, GreedyResolverTest0) {
    ...
    edm::track_candidate_collection<default_algebra>::host trk_cands{mng_mr};
        ...
        resolution_config, {mng_mr}, copy, stream);
    {
        ...
        auto res_trk_cands_buffer = resolution_alg_cuda(
            vecmem::get_data(trk_cands), vecmem::get_data(measurements));
        stream.synchronize();
...
TEST(CudaAmbiguitySolverTests, CPU_Comparison) {
    ...
    for (std::size_t i_evt = 0; i_evt < 5u; i_evt++) {

        std::size_t sd = 42 + i_evt;
        std::mt19937 gen(sd);
        std::cout << "Event: " << i_evt << " Seed: " << sd << std::endl;

        edm::track_candidate_collection<default_algebra>::host trk_cands{
            host_mr};
        ...
        traccc::edm::track_candidate_collection<default_algebra>::buffer
            trk_cands_buffer =
                copy.to(vecmem::get_data(trk_cands), device_mr, &host_mr,
                        vecmem::copy::type::host_to_device);
        measurement_collection_types::buffer measurements_buffer =
            copy.to(vecmem::get_data(measurements), device_mr,
                    vecmem::copy::type::host_to_device);
        ...
        traccc::edm::track_candidate_collection<default_algebra>::buffer
            res_trk_cands_buffer =
                resolution_alg_cuda(trk_cands_buffer, measurements_buffer);
        stream.synchronize();
...
TEST(CudaAmbiguitySolverTests, GreedyResolverTest7) {
    ...
    trk_cands.resize(3u);
    fill_pattern(trk_cands, measurements, 0, 0.173853f, {10, 3, 6, 8});
    fill_pattern(trk_cands, measurements, 1, 0.548019f, {3, 3, 1});
    fill_pattern(trk_cands, measurements, 2, 0.276757f, {2, 8, 5, 4});
...
TEST(CudaAmbiguitySolverTests, GreedyResolverTest8) {
    ...
    trk_cands.resize(5u);
    fill_pattern(trk_cands, measurements, 0, 0.0623132f, {10, 4});
    fill_pattern(trk_cands, measurements, 1, 0.207417f, {6, 7, 5});
    fill_pattern(trk_cands, measurements, 2, 0.325736f, {8, 2, 2});
    fill_pattern(trk_cands, measurements, 3, 0.581643f, {5, 7, 9, 7});
    fill_pattern(trk_cands, measurements, 4, 0.389551f, {1, 9, 3, 0});
...
TEST(CudaAmbiguitySolverTests, GreedyResolverTest9) {
    ...
    trk_cands.resize(3u);
    fill_pattern(trk_cands, measurements, 0, 0.542984f, {0, 4, 8, 1, 1});
    fill_pattern(trk_cands, measurements, 1, 0.583695f, {10, 6, 8, 7});
    fill_pattern(trk_cands, measurements, 2, 0.280232f, {4, 1, 8, 10});
...
TEST(CudaAmbiguitySolverTests, GreedyResolverTest10) {
    ...
    trk_cands.resize(5u);
    fill_pattern(trk_cands, measurements, 0, 0.399106f, {14, 51});
    fill_pattern(trk_cands, measurements, 1, 0.43899f, {80, 35, 41, 55});
    fill_pattern(trk_cands, measurements, 2, 0.0954247f, {73, 63, 49, 89});
    fill_pattern(trk_cands, measurements, 3, 0.158046f, {81, 22, 58, 54, 91});
    fill_pattern(trk_cands, measurements, 4, 0.349878f, {97, 89, 80});
...
TEST(CudaAmbiguitySolverTests, GreedyResolverTest11) {
    ...
    trk_cands.resize(5u);
    fill_pattern(trk_cands, measurements, 0, 0.95f, {56, 87});
    fill_pattern(trk_cands, measurements, 1, 0.894f, {64, 63});
    fill_pattern(trk_cands, measurements, 2, 0.824f, {70, 17});
    fill_pattern(trk_cands, measurements, 3, 0.862f, {27, 0});
    fill_pattern(trk_cands, measurements, 4, 0.871f, {27, 19});
...
TEST(CudaAmbiguitySolverTests, GreedyResolverTest12) {
    ...
    trk_cands.resize(5u);
    fill_pattern(trk_cands, measurements, 0, 0.948f, {17, 6, 1, 69, 78});  // 69
    fill_pattern(trk_cands, measurements, 1, 0.609f, {17});
    fill_pattern(trk_cands, measurements, 2, 0.453f,
                 {84, 45, 81, 69});  // 84, 69
    fill_pattern(trk_cands, measurements, 3, 0.910f,
                 {54, 64, 49, 96, 40});  // 64
    fill_pattern(trk_cands, measurements, 4, 0.153f,
                 {59, 57, 84, 27, 64});  // 84, 64
...
TEST(CudaAmbiguitySolverTests, GreedyResolverTest13) {
    ...
    trk_cands.resize(6u);
    fill_pattern(trk_cands, measurements, 0, 0.211f, {46, 92, 74, 58});
    fill_pattern(trk_cands, measurements, 1, 0.694f, {15, 78, 9});
    fill_pattern(trk_cands, measurements, 2, 0.432f, {15, 4, 58, 68});
    fill_pattern(trk_cands, measurements, 3, 0.958f, {38, 93, 68});
    fill_pattern(trk_cands, measurements, 4, 0.203f, {57, 64, 57, 36});
    fill_pattern(trk_cands, measurements, 5, 0.118f, {4, 85, 65, 14});
...
TEST(CudaAmbiguitySolverTests, GreedyResolverTest14) {
    ...
    trk_cands.resize(4u);
    fill_pattern(trk_cands, measurements, 0, 0.932f, {8, 4, 3});
    fill_pattern(trk_cands, measurements, 1, 0.263f, {1, 1, 9, 3});
    fill_pattern(trk_cands, measurements, 2, 0.876f, {1, 2, 5});
    fill_pattern(trk_cands, measurements, 3, 0.058f, {2, 0, 4, 7});
...
TEST(CudaAmbiguitySolverTests, GreedyResolverTest15) {
    ...
    trk_cands.resize(4u);
    fill_pattern(trk_cands, measurements, 0, 0.293f, {2, 0, 4});
    fill_pattern(trk_cands, measurements, 1, 0.362f, {8, 4, 9, 3});
    fill_pattern(trk_cands, measurements, 2, 0.011f, {9, 4, 8, 4});
    fill_pattern(trk_cands, measurements, 3, 0.843f, {8, 7, 1});
...
TEST(CudaAmbiguitySolverTests, GreedyResolverTest16) {
    ...
    trk_cands.resize(5u);
    fill_pattern(trk_cands, measurements, 0, 0.622598f, {95, 24, 62, 83, 67});
    fill_pattern(trk_cands, measurements, 1, 0.541774f, {6, 52, 57, 87, 75});
    fill_pattern(trk_cands, measurements, 2, 0.361033f, {14, 52, 29, 79, 89});
    fill_pattern(trk_cands, measurements, 3, 0.622598f, {57, 85, 63, 90});
    fill_pattern(trk_cands, measurements, 4, 0.481157f, {80, 45, 94});
