...
namespace traccc {
    ...
    /// Convenience declaration for the spacepoint container data type to use in host code
    using spacepoint_container_data = container_data< geometry_id, spacepoint >;

    /// Convenience declaration for the spacepoint container buffer type to use in host code
    using spacepoint_container_buffer = container_buffer< geometry_id, spacepoint >;

    /// Convenience declaration for the spacepoint container view type to use in host code
