...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "build/allow_installing_when_downstream"
  WORKING_DIRECTORY "/home/slobod/Documents/Work/traccc/build/_deps/cccl-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "build/allow_installing_when_downstream")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("build/allow_installing_when_downstream" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/build/allow_installing_when_downstream")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"build/allow_installing_when_downstream\" is not present locally, and not "
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/slobod/Documents/Work/traccc/build/_deps/cccl-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/slobod/Documents/Work/traccc/build/_deps/cccl-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
