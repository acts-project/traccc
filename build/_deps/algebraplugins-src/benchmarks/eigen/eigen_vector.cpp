...
int main(int argc, char** argv) {
  ...
  vector_binaryOP_bm<eigen::vector3, float, bench_op::sub> v_sub_s{cfg};
  vector_binaryOP_bm<eigen::vector3, float, bench_op::dot> v_dot_s{cfg};
  vector_binaryOP_bm<eigen::vector3, float, bench_op::cross> v_cross_s{cfg};
  vector_unaryOP_bm<eigen::vector3, float, bench_op::normalize> v_normalize_s{
      cfg};

  vector_binaryOP_bm<eigen::vector3, double, bench_op::add> v_add_d{cfg};
  vector_binaryOP_bm<eigen::vector3, double, bench_op::sub> v_sub_d{cfg};
  vector_binaryOP_bm<eigen::vector3, double, bench_op::dot> v_dot_d{cfg};
  vector_binaryOP_bm<eigen::vector3, double, bench_op::cross> v_cross_d{cfg};
  vector_unaryOP_bm<eigen::vector3, double, bench_op::normalize> v_normalize_d{
      cfg};

  std::cout << "Algebra-Plugins 'vector' benchmark (Eigen)\n"
            << "------------------------------------------\n\n"
            << cfg;
